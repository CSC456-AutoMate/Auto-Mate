    ...
    <div class="flex h-screen bg-slate-400">
      <div class="w-full max-w-xs m-auto bg-white rounded-lg p-5">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>          
            <button class="w-full bg-indigo-700 hover:bg-green-700 text-white font-bold py-2 px-4 mb-6 rounded" type="submit">Login</button>
          </div>       
        </form>
        <a class="text-indigo-700 hover:text-green-700 text-sm flex justify-center items-center"><Link to="/signup">Dont Have an Account? Signup</Link></a>
      </div>
    </div>
  )
}
